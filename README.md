...
[![Goreport status](https://goreportcard.com/badge/github.com/AnomalyFi/anchor)](https://goreportcard.com/report/github.com/AnomalyFi/anchor)
[![Test status](https://github.com/AnomalyFi/anchor/workflows/Tests/badge.svg?branch=develop)](https://github.com/AnomalyFi/anchor/actions?query=workflow%3A%22Tests%22)
[![Docker hub](https://badgen.net/docker/size/AnomalyFi/anchor?icon=docker&label=image)](https://hub.docker.com/r/AnomalyFi/anchor/tags)
...
![MEV-Boost service integration overview](https://raw.githubusercontent.com/AnomalyFi/anchor/54567443e718b09f8034d677723476b679782fb7/docs/mev-boost-integration-overview.png)
...
* [MEV-Boost Docker images](https://hub.docker.com/r/AnomalyFi/anchor)
* [Wiki](https://github.com/AnomalyFi/anchor/wiki)
* Specs:
...
Read more in [Why run MEV-Boost?](https://writings.flashbots.net/why-run-mevboost/) and in the [Frequently Asked Questions](https://github.com/AnomalyFi/anchor/wiki/Frequently-Asked-Questions).
...
https://github.com/AnomalyFi/anchor/releases
...
```bash
go install github.com/AnomalyFi/anchor@latest
mev-boost -help
```

### Clone and Build

Ensure you are downloading the most updated MEV-Boost release. Releases are available at https://github.com/AnomalyFi/anchor/releases

clone the repository and build it:

```bash
# By default, the develop branch includes ongoing merged PRs a future release.
git clone https://github.com/AnomalyFi/anchor.git
cd mev-boost

# You can use the stable branch, which is always updated with the latest released version
git checkout stable

# If you want to build a specific release, check out the tag. See also https://github.com/AnomalyFi/anchor/releases
...
We maintain a MEV-Boost Docker images at https://hub.docker.com/r/AnomalyFi/anchor
...
docker pull AnomalyFi/anchor:latest

# Run it
docker run AnomalyFi/anchor -help
```
...
Please take a look at the specific release documentation about the available command line flags: https://github.com/AnomalyFi/anchor/releases
...
These are the CLI arguments for the develop branch. For arguments available in a specific release, check the [release page](https://github.com/AnomalyFi/anchor/releases).
...
- If you have a question, feedback or a bug report for this project, please [open a new Issue](https://github.com/AnomalyFi/anchor/issues).
